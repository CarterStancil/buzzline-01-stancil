...
ADJECTIVES: list = ["extravagant", "hilarious", "dull", "interesting", "unusual"]
ACTIONS: list = ["discovered", "saw", "attempted", "collaborated", "loved"]
TOPICS: list = ["a song", "a meme", "a show", "an event", "a poem"]
